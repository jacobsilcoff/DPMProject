...
public class Odometer extends OdometerData implements Runnable {
  ...
  private Odometer() throws OdometerExceptions {
    ...
    this.DIST_MULT = (Math.PI * Lab5.WHEEL_RAD / 180);
  ...
  public void run() {
    ...
    while (true) {
      ...
      int leftDiff = Lab5.LEFT_MOTOR.getTachoCount() - leftMotorTachoCount;
      int rightDiff = Lab5.RIGHT_MOTOR.getTachoCount() - rightMotorTachoCount;
      ...
      dt = Math.toDegrees((leftDist - rightDist) / Lab5.TRACK);
